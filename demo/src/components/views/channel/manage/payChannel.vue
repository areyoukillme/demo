      ...
      <Col span="24">
        <div class="common-inner-div">
          <Form ref="order" :model="formItem" :label-width="100">
            <Row>
              <Col span="8">
                <FormItem label="支付渠道编号" class="pay-line-input">
                  <Input v-model="formItem.customerName" placeholder="请输入支付渠道编号"></Input>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem label="支付渠道名称" class="pay-line-input">
                  <Input v-model="formItem.customerName" placeholder="请输入支付渠道名称"></Input>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem label="所属合作机构" class="pay-line-input">
                  <Input v-model="formItem.customerName" placeholder="请输入所属合作机构"></Input>
                </FormItem>
              </Col>
            </Row>
            <Row>
              <Col span="8">
                <FormItem label="支付方式" class="pay-line-input">
                  <Input v-model="formItem.customerName" placeholder="请输入支付方式"></Input>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem label="账户类型" class="pay-line-input">
                  <Input v-model="formItem.customerName" placeholder="请输入账户类型"></Input>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem label="卡类型" class="pay-line-input">
                  <Input v-model="formItem.customerName" placeholder="请输入卡类型"></Input>
                </FormItem>
              </Col>
            </Row>
            <Row>
    ...
    <Row>
      ...
      <Col span="24" class="merchant-list-group-btn">
        <ButtonGroup>
          ...
          <Button type="ghost" icon="locked" @click="auditItem" :disabled="selection.length != 1">审核</Button>
